...
/**
 * Will return the path and topcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'topcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'topcore-node.json'))
  };
}
