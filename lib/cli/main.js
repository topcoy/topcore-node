...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `topcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ topcore-node add wallet-service');
      console.log('    $ topcore-node add top-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ topcore-node remove wallet-service');
      console.log('    $ topcore-node remove top-api');
      console.log();
    });
